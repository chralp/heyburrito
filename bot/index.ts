...
import WEBHandler from "../src/web";
import APIHandler from "../src/api";

import config from "../src/config";
import { response, server } from "spdy";
...
init().then(() => {
    ...
    server.get(`${config.http.api_path}*`, async (req, res) => {
        await APIHandler(req, res);
    });

    server.get(`${config.http.web_path}*`, async (req, res) => {
